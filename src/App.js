...
function App() {
  return (
    <HashRouter>
      <Routes>
        <Route path="/" element={<TemplatePage child={<Count />}/>}/>
        <Route path="/company" element={<TemplatePage filter ={<Filters />} child = {<ListCompany products = {company} />}/>}/>
        <Route path="/cnae" element={<TemplatePage filter ={<Filters />} child = {<ListCnae products = {cnae} />}/>}/>
        <Route path="/decisionMakers" element={<TemplatePage filter ={<Filters />} child = {<ListDecision products = {decision} />}/>}/>
        <Route path="/departament" element={<TemplatePage filter ={<Filters />} child = {<ListDepartament products = {departament} />}/>}/>
        <Route path="/sector" element={<TemplatePage filter ={<Filters />} child = {<ListSector products = {sector} />}/>}/>
        <Route path="/office" element={<TemplatePage filter ={<Filters />} child = {<ListOffice products = {office} />}/>}/>
      </Routes>
    </HashRouter>
  );
}
